...
- Self-Improving Agent Loop (설계) (community resource)
- ADR: Self-Improving Loop (결정) (community resource)
...
### 참조 ADR · 설계 문서
- Self-Improving Agent Loop 설계 (community resource) — 트레이스 → 개선 루프 설계
- ADR: Self-Improving Loop (community resource) — 결정 배경
- Agentic AI Platform Architecture (community resource) — 플랫폼 전체 구조
