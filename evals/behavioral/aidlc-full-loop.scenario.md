...
plugin: aidlc-inception, aidlc-construction, agenticops
...
- [ ] OMA 플러그인 설치 완료: `aidlc-inception`, `aidlc-construction`, `agenticops`
...
- **예상 도구 호출**: `Bash` `ls plugins/aidlc-inception/SKILL.md`, `Bash` `ls plugins/aidlc-construction/SKILL.md`, `Bash` `ls plugins/agenticops/SKILL.md`
- **예상 검증**:
...
- **예상 도구 호출**: `Skill` `aidlc-construction:component-design`, `Skill` `aidlc-construction:agentic-tdd`, `Skill` `aidlc-construction:code-generation`, `Skill` `aidlc-construction:pr-draft`
- **예상 산출물**:
...
| 증상 | 원인 | 복구 |
|---|---|---|
| Pre-flight에서 플러그인 누락 오류 | `aidlc-inception` 등 미설치 | `oma setup` 또는 `bash scripts/install/claude.sh` 재실행 |
