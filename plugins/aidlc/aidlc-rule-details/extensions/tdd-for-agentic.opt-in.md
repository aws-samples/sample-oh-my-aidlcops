...
**Extension**: AIDLC Construction — TDD for Agentic Systems (aidlc plugin, construction phase)
...
4. **Skill Loading** — 본 확장이 활성화되면 `aidlc` (construction) 플러그인의 3개 skill(component-design, code-generation, test-strategy) under plugins/aidlc/skills/construction/이 Construction 단계 실행 환경에 자동 등록됩니다.
...
- [aidlc plugin — CLAUDE.md](../../CLAUDE.md) — 플러그인 전체 설명
