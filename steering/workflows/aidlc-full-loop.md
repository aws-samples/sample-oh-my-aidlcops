...
- **CAN**: 플러그인 스킬 호출(aidlc, agenticops)
...
| 2 | aidlc 플러그인 (inception 스킬 그룹) 존재 | `ls plugins/aidlc/SKILL.md` | 설치 후 재시도 |
| 3 | aidlc 플러그인 (construction 스킬 그룹) 존재 | `ls plugins/aidlc/SKILL.md` | 설치 후 재시도 |
...
| 2. aidlc inception skills     |  P/F   |                     |
| 3. aidlc construction skills  |  P/F   |                     |
...
aidlc 플러그인 inception 스킬을 다음 순서로 호출합니다.
...
aidlc 플러그인 construction 스킬을 다음 순서로 호출합니다.
