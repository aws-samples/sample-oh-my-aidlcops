...
| 2 | 필수 플러그인 존재 | `ls .claude/plugins/aidlc` 등 | 설치 후 재시도 |
...
2. aidlc inception skills: PASS
3. aidlc construction skills: PASS
...
- [structured-intake](../../plugins/aidlc/skills/structured-intake.md) — 구조화된 컨텍스트 수집 템플릿
