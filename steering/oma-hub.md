...
| "EKS에 Agentic Platform 구축" / "platform-bootstrap" | `/oma:platform-bootstrap` | agentic-platform | Infra bootstrap |
...
| Plugin | Role | 소스 |
|--------|------|------|
| **agentic-platform** | EKS 위 vLLM·Inference Gateway·Langfuse·Kagent 구축·운영 스킬 | `plugins/agentic-platform/` |
